<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="author.aspx.cs" Inherits="prjOnlineBookstore.author" %>
        ...
        <div>
            <br />
                    <asp:Panel ID="panVehicules" runat="server" Width="1520px" GroupingText="Book Search" HorizontalAlign="Center" CssClass=".panel">
                        <br />
                        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Author:&nbsp;&nbsp;<asp:DropDownList ID="ddlstAuthor" runat="server" Width="182px">
                        </asp:DropDownList>
                        <br />
                        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;<br />
                        &nbsp;&nbsp;&nbsp;&nbsp;
