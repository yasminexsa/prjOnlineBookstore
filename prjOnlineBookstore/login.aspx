<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="login.aspx.cs" Inherits="prjOnlineBookstore.login" %>
  ...
  <body class="u-body u-xl-mode" data-lang="fr">
    ...
    <section class="u-align-center u-clearfix u-grey-5 u-section-1" id="carousel_cc94">
      <div class="u-clearfix u-sheet u-sheet-1">
        ...
        <a href="adminLogin.aspx" class="u-border-active-palette-2-base u-border-hover-palette-2-base u-border-none u-btn u-button-style u-login-control u-login-forgot-password u-none u-text-hover-black u-text-palette-4-dark-2 u-btn-2">Admin? Log in here.</a>
        <a href="register.aspx" class="u-border-active-palette-2-base u-border-hover-palette-1-base u-border-none u-btn u-button-style u-login-control u-login-create-account u-none u-text-hover-black u-text-palette-4-dark-2 u-btn-3">Don't have an account?</a>
      </div>
    </section>
