<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="bookList.aspx.cs" Inherits="prjOnlineBookstore.bookList" %>
...
<link rel="stylesheet" href="Page-1.css" media="screen">
  ...
  <body class="u-body u-xl-mode" data-lang="fr"><header class="u-clearfix u-header u-white u-header" id="sec-0ea9"><a href="https://nicepage.com" class="u-image u-logo u-image-1" data-image-width="2000" data-image-height="1500">
      ...
      <form id="form1" runat="server">
        <div>
        <asp:GridView ID="gridBooks" runat="server" BackColor="#1BBEBE" CellPadding="4" ForeColor="#018080" Width="1502px" GridLines="None" AutoGenerateColumns="false">
            <Columns>
